...
export function WhatsAppButton() {
  ...
  const message = encodeURIComponent("Olá! Gostaria de um diagnóstico gratuito para minha empresa.");
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-[999] bg-[#25D366] p-4 rounded-full shadow-[0_0_20px_rgba(37,211,102,0.4)] flex items-center justify-center group"
    >
